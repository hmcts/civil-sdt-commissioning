...
public class BulkFeedbackConfigBOne {
    ...
    public void invokingBean() {
        ...
        methodInvokingFactoryBean.setArguments(Lists.newArrayList(Lists.newArrayList("USER_REQUEST_ID_B1a",
                                                                                     "mcolClaim",
                                                                                     "Rejected",
                                                                                     "DUP_CUST_REQID",
                                                                                     "Duplicate User Request Identifier submitted USER_REQUEST_ID_B1a.",
                                                                                     ""),
                                                                  Lists.newArrayList("USER_REQUEST_ID_B1b",
                                                                                     "mcolJudgment",
                                                                                     "Rejected",
                                                                                     "DUPLD_CUST_REQID",
                                                                  ...
                                                                  Lists.newArrayList("USER_REQUEST_ID_B1b",
                                                                                     ...
                                                                                     "Unique Request Identifier has been specified more than once within the originating Bulk Request.",
                                                                                     ""),
                                                                  Lists.newArrayList("USER_REQUEST_ID_B2",
                                                                                     "mcolClaim",
                                                                                     "Rejected",
                                                                                     "8",
                                                                                     "First defendant's postcode is not in England or Wales.",
                                                                                     ""),
                                                                  Lists.newArrayList("USER_REQUEST_ID_B3",
                                                                                     "mcolJudgment",
                                                                                     "Initially Accepted",
                                                                                     "", "",
                                                                                     """
                                                                  ...
                                                                  Lists.newArrayList("USER_REQUEST_ID_B4",
                                                                                     ...
                                                                                     "Initially Accepted",
                                                                                     "DUP_CUST_REQID", "", "", ""),
                                                                                     Lists.newArrayList("USER_REQUEST_ID_B5",
                                                                                     "mcolJudgment",
                                                                                     "Rejected",
                                                                                     "24",
                                                                                     ...
                                                                                     "mcolClaim",
                                                                                     "Received","", "", ""),
                                                                                     Lists.newArrayList("USER_REQUEST_ID_B15",
                                                                                     "mcolJudgment",
                                                                                     "Received", "", "", ""),
