...
class SubmitQueryConfigMcolDefenceThreeTest extends SubmitQueryConfigTestBase {

    private SubmitQueryConfigMcolDefenceThree submitQueryConfigMcolDefenceThree;

    @Override
    protected void setUpLocalTests() {
        submitQueryConfigMcolDefenceThree = new SubmitQueryConfigMcolDefenceThree();
    }

    @Test
    void testSubmitQueryRequest() {
        SubmitQueryRequest submitQueryRequest = submitQueryConfigMcolDefenceThree.submitQueryRequest();

        IErrorLog expectedErrorLog = new ErrorLog();
        expectedErrorLog.setErrorCode("78");
        expectedErrorLog.setErrorText("Results truncated - maximum number allowed reached.");
